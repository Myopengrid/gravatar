...
class API
{
	...
	{
		return Config::get('settings::core.gravatar_size', 80);
	}
	...
	{
		return Config::get('settings::core.gravatar_default_image');
	}
	...
	{
		return Config::get('settings::core.gravatar_rating', 'g');
	}
